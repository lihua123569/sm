...
public class ResultHandle {
	...
	public static Map<String, Object> success(){
		...
		result.put(RESPONSE_CODE, ErrorCodeEnum.SUCCESS.getCode());
		
		result.put(RESPONSE_MSG, ErrorCodeEnum.SUCCESS.getDescription());
	...
	public static Map<String, Object> fail(Map<String, Object> result ,ErrorCodeEnum errorCodeEnum){
		...
		result.put(RESPONSE_CODE, errorCodeEnum.getCode());
		
		result.put(RESPONSE_MSG, errorCodeEnum.getDescription());
